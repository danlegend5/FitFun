fit_flow_density_with_GZ1961Ckjf_GaussSigCon = function(traffic_data, ngrid, upper_density, output_files) {
...
tryCatch(
  { model_obj = gamlss(V3 ~ 0 + I(V2*(1.0 - ((V2/k_jam)^2))), sigma.formula = ~ 1, family = NO(), data = traffic_data)
