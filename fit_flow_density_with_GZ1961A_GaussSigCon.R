fit_flow_density_with_GZ1961A_GaussSigCon = function(traffic_data, ngrid, upper_density, output_files) {
...
tryCatch(
  { model_obj = gamlss(V3 ~ 0 + sqrt(V2) + V2, sigma.formula = ~ 1, family = NO(), data = traffic_data)
