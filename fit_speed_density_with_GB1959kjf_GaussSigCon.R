fit_speed_density_with_GB1959kjf_GaussSigCon = function(traffic_data, ngrid, upper_density, output_files) {
...
#              script "FitFun.R". The model component for the functional form of the speed-density relationship is the Greenberg model with fixed
#              jam density (GB1959kjf). The model component for the noise in the speed-density relationship is defined as independent observations
...
tryCatch(
  { model_obj = gamlss(V3 ~ 0 + log(k_jam/V2), sigma.formula = ~ 1, family = NO(), data = traffic_data)
