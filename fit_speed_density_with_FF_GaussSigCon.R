fit_speed_density_with_FF_GaussSigCon = function(traffic_data, ngrid, upper_density, output_files) {
...
#              script "FitFun.R". The model component for the functional form of the speed-density relationship is the free-flow model (FF). The
...
tryCatch(
  { model_obj = gamlss(V3 ~ 1, sigma.formula = ~ 1, family = NO(), data = traffic_data)
