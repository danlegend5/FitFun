fit_speed_density_with_BM1977_GaussSigCon = function(traffic_data, ngrid, upper_density, output_files) {
...
#              script "FitFun.R". The model component for the functional form of the speed-density relationship is the Boardman model (BM1977). The
...
tryCatch(
  { model_obj = gamlss(V3 ~ 1 + V2 + I(V2^2), sigma.formula = ~ 1, family = NO(mu.link = 'log'), data = traffic_data)
