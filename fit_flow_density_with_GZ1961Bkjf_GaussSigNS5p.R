fit_flow_density_with_GZ1961Bkjf_GaussSigNS5p = function(traffic_data, ngrid, upper_density, output_files) {
...
tryCatch(
  { model_obj = gamlss(V3 ~ 0 + I(V2*(1.0 - sqrt(V2/k_jam))), sigma.formula = ~ ns(V2, df = 4), family = NO(), data = traffic_data,
