fit_flow_density_with_GZ1961F_GaussSigCon = function(traffic_data, ngrid, upper_density, output_files) {
...
tryCatch(
  { model_obj = gamlss(V3 ~ 1 + offset(log(V2)) + I(V2^2), sigma.formula = ~ 1, family = NO(mu.link = 'log'), data = traffic_data)
