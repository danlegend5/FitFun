fit_flow_density_with_SN2014_GaussSigNS5p = function(traffic_data, ngrid, upper_density, output_files) {
...
#              The density dependence of the log of the standard deviation is modelled using natural cubic splines with five effective free
#              parameters (GaussSigNS5p).
