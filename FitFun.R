...
if (fd_type == 'Flow.Density') {
  ...
  # If the model component for the functional form of the flow-density relationship is the Greenshields model (GS1935)
  } else if (functional_form_model == 'GS1935') {
  ...
  # If the model component for the functional form of the flow-density relationship is the Greenshields model with fixed jam density (GS1935kjf)
...
# If the form of the FD relationship is speed-density
  ...
  # If the model component for the functional form of the speed-density relationship is the Greenshields model (GS1935)
  } else if (functional_form_model == 'GS1935') {
