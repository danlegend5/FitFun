fit_flow_density_with_GZ1961C_GaussSigNS5p = function(traffic_data, ngrid, upper_density, output_files) {
...
tryCatch(
  { model_obj = gamlss(V3 ~ 0 + V2 + I(V2^3), sigma.formula = ~ ns(V2, df = 4), family = NO(), data = traffic_data,
