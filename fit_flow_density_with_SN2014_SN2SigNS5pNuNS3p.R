fit_flow_density_with_SN2014_SN2SigNS5pNuNS3p = function(traffic_data, ngrid, upper_density, output_files) {
...
#              component for the noise in the flow-density relationship is defined as independent observations that follow a Skew Normal Type II
#              distribution. The density dependence of the log of the scale parameter and the log of the skewness parameter is modelled using
